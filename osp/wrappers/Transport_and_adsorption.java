...
/** Model exported on Jul 8 2020, 17:07 by COMSOL 5.4.0.295. */
public class Transport_and_adsorption {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model.modelPath("/home/skywalker/RNANO/Projects/SimPhoNy/final");
  ...
  public static Model run2(Model model) {
    ...
    model.result().report("rpt1").set("filename", "/home/skywalker/RNANO/Projects/SimPhoNy/final/Untitled.docx");
    model.result().report("rpt1").feature().clear();
    model.result().report("rpt1").create("tp1", "TitlePage");
    model.result().report("rpt1").create("toc1", "TableOfContents");
    model.result().report("rpt1").create("sec1", "Section");
    ...
    model.label("Transport_and_adsorption_v2.mph");
